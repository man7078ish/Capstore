...
//	public List<Product> findByProductCategoryOrderByProductPriceAsc(Category category);
	
//	public List<Product> findByProductCategoryOrderByProductPriceDesc(Category category);
